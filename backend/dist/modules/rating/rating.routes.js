...
router.get("/jobs/:jobId/eligible-workers", auth_middleware_1.authenticate, (0, role_middleware_1.authorizeRoles)("EMPLOYER"), (0, validate_middleware_1.validate)(rating_validation_1.getEligibleWorkersSchema), rating_controller_1.ratingController.getEligibleWorkers);
...
router.get("/job/:jobId", auth_middleware_1.authenticate, (0, role_middleware_1.authorizeRoles)("WORKER"), (0, validate_middleware_1.validate)(rating_validation_1.getJobRatingsSchema), rating_controller_1.ratingController.getJobRatings);
